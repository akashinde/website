        ...
        <>
            <button onClick={handleViewClick} className={`p-2 mb-5 border cursor-pointer hover:bg-black hover:text-white ${state.class}`}>{state.name}</button>
            {
                ...
                (<>
                    ...
                    <div className="p-5 leading-7 flex flex-col gap-3 border border-dashed hover:bg-black hover:text-white">
                        ...
                        <p>I enjoy designing solid software architecture (following SOLID principles), writing clean, test-driven code, optimizing databases, and working with containers.</p>
